...
from src.handlers.routes.approval import router as approval_router
from src.handlers.routes.cases import router as cases_router
...
async def handle_unexpected_error(_: any, exc: Exception) -> JSONResponse:
    logger.exception("Unhandled error in Automation API")
